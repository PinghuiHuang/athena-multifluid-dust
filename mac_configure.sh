...
hdf5path=/usr/local/Cellar/hdf5-mpi/1.14.5
fftwpath=/usr/local/Cellar/fftw/3.3.10_1
...
#python3 configure.py --prob=disk_VSI --coord=spherical_polar --ndustfluids=1 --nghost=2 --nscalars=1 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple

#python3 configure.py --prob=disk_test --coord=spherical_polar --ndustfluids=1 --nghost=2 --nscalars=0 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple
...
#python3 configure.py --prob=disk_planet_dust_cylindrical_2 --coord=cylindrical --ndustfluids=1 --nscalars=0 --nghost=2 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double #-omp --cxx=clang++-apple

#python3 configure.py --prob=disk --coord=cylindrical --ndustfluids=0 --nscalars=0 --nghost=2 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double #-omp --cxx=clang++-apple

#python3 configure.py --prob=disk_planet_dust_spherical --coord=spherical_polar --ndustfluids=1 --nscalars=0 --nghost=2 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple
...
#python3 configure.py --prob=kh_dust --ndustfluids=1 --nscalars=0 --nghost=2 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple

#python3 configure.py --prob=kh --ndustfluids=1 --nscalars=1 --nghost=2 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple #-debug
...
#python3 configure.py --prob=ssheet_planet_dust_selfgravity --eos=isothermal --nghost=2 --ndustfluids=0 --nscalars=0 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple -fft --fftw_path=${fftwpath} --grav=fft
...
#python3 configure.py --prob=ssheet_RWI_dust_gap --eos=isothermal --nghost=2 --ndustfluids=0 --nscalars=0 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple

#python3 configure.py --prob=ssheet_planet_dust_outflow --eos=isothermal --nghost=2 --ndustfluids=0 --nscalars=0 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple

#python3 configure.py --prob=streaming_eigen --ndustfluids=1 --eos=isothermal --nghost=3 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double --flux=hlle -omp --cxx=clang++-apple

#python3 configure.py --prob=streaming_eigen_2dust --ndustfluids=2 --eos=isothermal --nghost=3 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double --flux=hlle -omp --cxx=clang++-apple

#python3 configure.py --prob=streaming_nonlinear --ndustfluids=1 --eos=isothermal --nghost=3 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double --flux=roe -omp --cxx=clang++-apple

#python3 configure.py --prob=streaming_nonlinear_hb3 -b --ndustfluids=1 --eos=isothermal --nghost=4 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double --flux=roe -omp --cxx=clang++-apple
...
#python3 configure.py --prob=streaming_stratified_cartesian --ndustfluids=1 --eos=isothermal --nghost=2 -mpi -hdf5 --hdf5_path=${hdf5path} -h5double --flux=roe -omp --cxx=clang++-apple

#python3 configure.py --prob=turb -hdf5 --hdf5_path=${hdf5path} -fft --fftw_path=${fftwpath} -omp --cxx=clang++-apple

#python3 configure.py --prob=poisson -hdf5 --hdf5_path=${hdf5path} -h5double -fft --fftw_path=${fftwpath} --grav=fft --eos=isothermal -mpi -omp --cxx=clang++-apple
#

#python3 configure.py -b --prob=hb3 --flux=hlld --eos=isothermal -mpi -hdf5 --hdf5_path=${hdf5path} -h5double -omp --cxx=clang++-apple
