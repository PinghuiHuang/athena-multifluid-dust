...
#pragma omp simd
          for (int i=is; i<=ie; ++i) {
            ...
            force_x1_n(idx, i) = alpha_n(idx, i)*(epsilon_n(idx, i)*mom1_w_n(0, i) - dust_mom1_bf_src);
            force_x2_n(idx, i) = alpha_n(idx, i)*(epsilon_n(idx, i)*mom2_w_n(0, i) - dust_mom2_bf_src);
            force_x3_n(idx, i) = alpha_n(idx, i)*(epsilon_n(idx, i)*mom3_w_n(0, i) - dust_mom3_bf_src);

            force_x1(idx, i) = alpha(idx, i)*(epsilon(idx, i)*mom1_w_n(0, i) - dust_mom1_bf_src);
            force_x2(idx, i) = alpha(idx, i)*(epsilon(idx, i)*mom2_w_n(0, i) - dust_mom2_bf_src);
            force_x3(idx, i) = alpha(idx, i)*(epsilon(idx, i)*mom3_w_n(0, i) - dust_mom3_bf_src);
...
#pragma omp simd
        for (int i=is; i<=ie; ++i) {
          ...
          delta_mom1_src(0, i) = (u_af_src(IM1, k, j, i) + delta_mom1(0, i) - mom1_w_n(0, i));
          delta_mom2_src(0, i) = (u_af_src(IM2, k, j, i) + delta_mom2(0, i) - mom2_w_n(0, i));
          delta_mom3_src(0, i) = (u_af_src(IM3, k, j, i) + delta_mom3(0, i) - mom3_w_n(0, i));
