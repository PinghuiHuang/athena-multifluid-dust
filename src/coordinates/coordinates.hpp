...
//!
//! This class provides data and functions to compute/store coordinate positions and
...
class Coordinates {
 public:
  ...
  // ...to compute geometrical source terms
  void AddDustFluidsCoordTermsDivergence(const Real dt, const AthenaArray<Real> *df_flux,
