...
// TODO(felker): consider combining with DustFluids and PassiveScalars implementation + (see 57cfe28b)
// (may rename to AddPhysicalFluxDivergence or AddQuantityFluxDivergence to explicitly
// distinguish from CoordTerms)
// (may rename to AddHydroFluxDivergence, AddDustFluidsFluxDivergenceand AddScalarsFluxDivergence, if
