...
struct OutputParameters {
  ...
  bool output_avgx1, output_avgx2, output_avgx3;
  bool output_maxx1, output_maxx2, output_maxx3;
  ...
  OutputParameters() : block_number(0), next_time(0.0), dt(0.0), file_number(0),
                       ...
                       output_avgx1(false), output_avgx2(false), output_avgx3(false),
                       output_maxx1(false), output_maxx2(false), output_maxx3(false),
...
class OutputType {
 public:
  ...
  void AvgOutputData(MeshBlock *pmb, int dim);
  void MaxOutputData(MeshBlock *pmb, int dim);
