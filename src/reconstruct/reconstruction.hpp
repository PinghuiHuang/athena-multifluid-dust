...
class Reconstruction {
 ...
 private:
  ...
  AthenaArray<Real> scr1_in_df_, scr2_in_df_, scr3_in_df_, scr4_in_df_, scr5_in_df_;
  AthenaArray<Real> scr1_in2_df_, scr2_in2_df_, scr3_in2_df_, scr4_in2_df_;
  AthenaArray<Real> scr1_nn_df_, scr2_nn_df_, scr3_nn_df_, scr4_nn_df_;
  AthenaArray<Real> scr6_in_df_, scr7_in_df_, scr8_in_df_;
};
