...
void InflowBoundary(MeshBlock *pmb, Coordinates *pcoord, AthenaArray<Real> &prim, AthenaArray<Real> &prim_df,
    FaceField &bb, Real time, Real dt, int il, int iu, int jl, int ju, int kl, int ku,
    int ngh);
void OutflowBoundary(MeshBlock *pmb, Coordinates *pcoord, AthenaArray<Real> &prim, AthenaArray<Real> &prim_df,
    FaceField &bb, Real time, Real dt, int il, int iu, int jl, int ju, int kl, int ku,
    int ngh);
