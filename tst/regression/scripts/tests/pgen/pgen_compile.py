...
dust_1_probs = set(['disk_3d_mhd_dust', 'disk_RWI_2D', 'disk_VSI', 'disk_dust_diffusion', 'disk_dust_drift',
                  'disk_planet_dust_cylindrical', 'disk_planet_dust_spherical', 'disk_streaming_cylindrical',
                  'dmr_dust', 'dust_NSH', 'dust_collision', 'dust_diffusion',
                  'dusty_kh', 'dusty_shock', 'dusty_soundwave', 'kh_dust',
                  'ssheet_RWI_dust', 'ssheet_planet_dust', 'ssheet_planet_dust_selfgravity',
                  'streaming_linear', 'streaming_nonlinear', 'streaming_stratified',
                  'visc_dustfluids'])
dust_2_probs = set(['dust_collision_different_Ts',
                  'dust_inelastic_collision',
                  'streaming_linear_2dust'])
...
hydro_probs = pgen_choices - gr_probs - mhd_probs - grav_mg_probs \
            - chem_probs - crdiff_probs - dust_1_probs - dust_2_probs
...
dust_1_args = ['-ndustfluids=1']
dust_2_args = ['-ndustfluids=2']
...
def prepare(**kwargs):
    ...
    for single_precision in [True, False]:
        ...
        # for pgen_set, args in zip([dust_1_probs, dust_2_probs],
                                  # [dust_1_args, dust_2_args]):
            args_lcl = list(args)
            if single_precision:
